...
export default function Home() {
  return (
    <>
      <header className="fixed top-0 inset-x-0 flex flex-wrap md:justify-start md:flex-nowrap z-50 w-full bg-neutral-900 text-sm py-2.5">
        <nav className="px-4 sm:px-6 flex basis-full items-center w-full mx-auto">
          <div className="w-full flex items-center gap-x-1.5">
            <ul className="flex items-center gap-1.5">
              <li className="inline-flex items-center relative text-gray-200 pe-1.5 last:pe-0 last:after:hidden after:absolute after:top-1/2 after:end-0 after:inline-block after:w-px after:h-3.5 after:bg-neutral-700 after:rounded-full after:-translate-y-1/2 after:rotate-12">
                <div className="hidden sm:block ms-1"></div>

                <button
                  type="button"
                  className="bg-red-500 p-1.5 size-8 inline-flex items-center gap-x-1 text-xs rounded-md border border-transparent text-gray-500 hover:text-gray-800 disabled:opacity-50 disabled:pointer-events-none focus:outline-none focus:text-gray-800"
                >
                  <ChevronLeft />
              ...
              {/* <li className="inline-flex items-center relative text-gray-200 pe-1.5 last:pe-0 last:after:hidden after:absolute after:top-1/2 after:end-0 after:inline-block after:w-px after:h-3.5 after:bg-gray-300 after:rounded-full after:-translate-y-1/2 after:rotate-12">
                <div className="inline-flex justify-center w-full">
                  <div className="relative inline-flex">
                    <button
                      type="button"
                      className="py-1 px-2 min-h-F8 flex items-center gap-x-1 font-medium text-sm rounded-lg hover:bg-gray-200 focus:outline-none focus:bg-gray-200 text-gray-200"
                      aria-label="Dropdown"
                    >
                      Server
                      <svg
      ...
      >
        <div className="lg:pt-13 relative flex flex-col h-full max-h-full">
          <nav className="p-3 size-full flex flex-col ">
            <button
              type="button"
              className="p-1.5 ps-2.5 w-full inline-flex items-center gap-x-2 text-sm rounded-lg bg-white border border-gray-200 text-gray-600 shadow-xs hover:border-gray-300 focus:outline-none focus:border-gray-300 disabled:opacity-50 disabled:pointer-events-none"
            >
              Search
      ...
      <main className="transition-all duration-300 lg:inset-0 pt-14 pb-3 ps-5 pe-2 lg:ps-64 bg-neutral-900">
        <div className="h-[calc(100dvh-62px)] bg-neutral-800 border-2 border-violet-800 shadow-lg rounded-lg px-5">
