  ...
  return (
    <div className="flex-1 w-full flex flex-col md:flex-row">
      ...
      <div className="flex flex-col items-center justify-center text-center md:text-left px-6 py-10 md:w-1/2">
        ...
        />
        <h1 className="text-2xl sm:text-3xl md:text-4xl font-semibold text-white max-w-xl md:flex hidden">
      ...
      <div className="flex items-center justify-center w-full md:w-1/2 px-4 md:py-10 perspective">
        <div
          className={`auth-card grid w-full max-w-md transition-transform duration-700 transform-style-preserve-3d ${
